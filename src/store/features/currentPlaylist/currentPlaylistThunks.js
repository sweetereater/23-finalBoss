...
} from "./currentPlaylistSlice";

export const getCurrentPlaylistTracks = createAsyncThunk(
  "currentPlayList/getPlaylistTracks",
...
export const removeTrackFromPlaylistThunk = createAsyncThunk(
  "currentPlayList/removeTrackFromPlaylist",
  async ({ playlistID, trackID, tracks }, { dispatch }) => {
    const response = await spotifyApi.removeTracksFromPlaylist(
      playlistID,
      tracks
    );
